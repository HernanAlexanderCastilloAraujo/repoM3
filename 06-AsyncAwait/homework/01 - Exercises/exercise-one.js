...
async function problemB() {
  ...
  // Tu código acá:
  try {
    let stanza2 = await exerciseUtils.promisifiedReadFile("poem-one/stanza-02.txt");
  
    let stanza3 = await exerciseUtils.promisifiedReadFile("poem-one/stanza-03.txt");
    exerciseUtils.blue(stanza2);
    exerciseUtils.blue(stanza3);
...
async function problemD() {
  ...
  // Tu código acá:
  try {
    let stanza4 = await exerciseUtils.promisifiedReadFile("poem-one/wrong-file-name.txt");
